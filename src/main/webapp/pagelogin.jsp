...
<div class="box_login">
  <form action="login.jsp" method="POST" class="form_login">
    <div class="content_box">
      <div class="perfil_txt">
        <p>Login</p>
      </div>
      <div class="campo-duplo_login">
        <div>
          <label for="nome-utilizador">Endereço de email</label>
          <input class="iptnome_login" type="text" id="nome-utilizador" name="nome-utilizador" required>
        </div>
        <div>
          <label for="senha">Palavra-passe</label>
          <input class="iptnome_login" type="password" id="senha" name="senha" required>
        </div>
      </div>
      <button class="button_login" type="submit">Fazer Login</button>
    </div>
    ...
    <div class="popup-overlay">
      <div class="popup-content">
        ...
        <p class="desc">Email ou senha incorretos, por favor tente novamente</p>
        <label class="close-btn" for="popupErro">Fechar</label>
      </div>
    </div>
  </form>
  <div class="contanaocriada">
    <p>Ainda não tem uma Conta Criada?</p>
  </div>
  <a href="criarconta.jsp" class="cc"><button class="button_criarconta">Criar Conta</button></a>
</div>
