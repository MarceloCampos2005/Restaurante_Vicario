...
<form action="adicionar.jsp" class="adicionar" method="post">
    <div class="container">
        ...
        <div class="direita">
            <img src="images/tinto.png" alt="vinho_tinto">
            <div class="card-content">
                <h2>Vinho Tinto</h2>
                <p>Intenso e encorpado, ideal para acompanhar pratos de<br> carne ou momentos especiais. Escolha perfeita para<br> apreciadores de tradição.</p>
                <p class="price">Preço: 18,00€</p>
                <input class="botao" onclick="selecionarPrato('vinho tinto')" type="submit" value="Adicionar ao pedido">
            </div>
        </div>

        <div class="esquerda">
            <img src="images/branco.png" alt="vinho_branco">
            <div class="card-content">
                <h2>Vinho Branco</h2>
                <p class="desc">Leve e aromático, com notas frutadas e frescas, ideal<br> para harmonizar com pratos leves e momentos de<br> descontração.</p>
                <p class="price">Preço: 17,00€</p>
                <input class="botao" onclick="selecionarPrato('vinho branco')" type="submit" value="Adicionar ao pedido">
            </div>
        </div>

        <div class="direita">
            <img src="images/champanhe.png" alt="champanhe">
            <div class="card-content">
                <h2>Champanhe</h2>
                <p>Elegante e borbulhante, com um equilíbrio perfeito de<br> frescura e sofisticação, ideal para celebrações<br> inesquecíveis.</p>
                <p class="price">Preço: 45,00€</p>
                <input class="botao" onclick="selecionarPrato('champanhe')" type="submit" value="Adicionar ao pedido">
            </div>
        </div>
        <input type="hidden" name="origem" value="bebidas.jsp">

        <div class="esquerda">
            <img src="images/agua.png" alt="agua">
            <div class="card-content">
                <h2>Água</h2>
                <p class="desc">Pura e refrescante, disponível em versões natural ou<br> fresca, perfeita para acompanhar qualquer refeição.</p>
                <p class="price">500 ml: 3,00€<br>1L: 5,00€</p>
                <label for="popup2" class="botao" onclick="selecionarPrato('agua')">Adicionar ao pedido</label>            </div>
        </div>
    </div>
    <!-- Popup -->
    ...
    <div class="popup-overlay">
        <div class="popup-content">
            ...
            <p class="cimabaixo2">
                ...
                <input class="dose" onclick="selecionarDose('meia')" type="submit" value="500 ml">
                <input class="dose" onclick="selecionarDose('1')" type="submit" value="1L">
            </p>
