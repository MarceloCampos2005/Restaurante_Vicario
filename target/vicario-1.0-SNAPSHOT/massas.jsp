...
<form action="adicionar.jsp" class="adicionar" method="post">
    <div class="container">
        <h1 class="titulo">Massas</h1>
        <input id="pratoSelecionado" name="pratoSelecionado" type="hidden">

        <div class="direita">
            <img alt="Carbonara" src="images/carbonara.png">
            <div class="card-content">
                <h2>Massa à Carbonara</h2>
                <p>Deliciosa mistura de massa com molho cremoso de ovos, <br> queijo e pancetta, para uma experiência
                    autêntica e saborosa.</p>
                <p class="price">Meia Dose: 10,00€<br>1 Dose: 17,00€</p>
                <label class="botao" for="popup2" onclick="selecionarPrato('carbonara')">Adicionar ao pedido</label>
            </div>
        </div>

        <div class="esquerda">
            <img alt="Bolonhesa" src="images/bolonhesa.png">
            <div class="card-content">
                <h2>Massa à Bolonhesa</h2>
                <p class="desc1">Massa envolvida em um molho rico e saboroso, com<br>carne moída e temperos frescos,
                    criando uma<br> combinação irresistível.</p>
                <p class="price">Meia Dose: 9,00€<br>1 Dose: 16,00€</p>
                <label class="botao" for="popup2" onclick="selecionarPrato('bolonhesa') ">Adicionar ao pedido</label>
            </div>
        </div>

        <div class="direita">
            <img alt="Massa_camarao" src="images/camaroes.png">
            <div class="card-content">
                <h2>Massa com Camarões</h2>
                <p>Massa delicada acompanhada de camarões suculentos,<br> cozidos em molho suave de alho e ervas
                    frescas.</p>
                <p class="price">Meia Dose: 13,00€<br>1 Dose: 22,00€</p>
                <label class="botao" for="popup2" onclick="selecionarPrato('camaroes') ">Adicionar ao pedido</label>
            </div>
        </div>

        <div class="esquerda">
            <img alt="Massa_atum" src="images/atum.png">
            <div class="card-content">
                <h2>Massa com Atum</h2>
                <p class="desc1">Massa envolvida em um molho leve de atum, tomate e<br> azeite, uma opção fresca e
                    saborosa para os amantes<br> de frutos do mar.</p>
                <p class="price">Meia Dose: 10,50€<br>1 Dose: 18,00€</p>
                <label class="botao" for="popup2" onclick="selecionarPrato('atum') ">Adicionar ao pedido</label>
            </div>
        </div>
    </div>
    <!-- Popup -->
    <input type="hidden" name="origem" value="massas.jsp">
    <input class="popup-checkbox" id="popup" type="checkbox">
    <div class="popup-overlay">
        <div class="popup-content">
            ...
            <label class="close-btn" for="popup">Fechar</label>
        </div>
    </div>
